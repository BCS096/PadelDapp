...
const App = ({ torneos }) => {
    ...
    const handleButtonClick = async (action, record) => {
        if (action == "club") {
            ...
            navigate(`/jugador/mis-torneos/${action}`);
        }
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    <Button className="button-actions" onClick={() => handleButtonClick('club', record)} type="primary">
                        Club
                    </Button>
                </Space>
            ),
    ...
    return (
        <>
            ...
            {
                infoModal && (
                    <Modal open={true} onCancel={closeInfoModal} onOk={closeInfoModal}>
                        <InfoClub />
                    </Modal>
                )
            }
